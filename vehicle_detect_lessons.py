...
def extract_features_color(imgs, cspace='RGB', spatial_size=(32, 32),
    ...
    for file in imgs:
        ...
        feature_image = color_space_conversion(image, color_space=cspace)
...
# Lesson Implementation functions ****************
def color_classify():
    # Read in car and non-car images
    cars, notcars = read_in_image_paths(sample_size=1000)
...
def hog_classify():
    # Read in car and non-car images
    cars, notcars = read_in_image_paths(sample_size=500)
...
def sliding_window_impl():

    image = mpimg.imread('test_images/test1.jpg')
    windows = slide_window(image, x_start_stop=[None, None], y_start_stop=[None, None], xy_window=(128, 128), xy_overlap=(.5, .5))
...
def search_and_classify():
    cars, notcars = read_in_image_paths(sample_size=0)
    ### TODO: Tweak these parameters and see how the results change.
